...
;; </ol>
;; Unlike the other two classes, 'DF.BLOB' provides a basic working implementation for 'DF.SQL' subclasses
;; to use. You may of course subclass it if your database requires additional functionality. It requires
;; special usage considerations, see its documentation below.
;; <h3>Example</h3>
;; <pre>
...
; TODO: move all of this to utils.lsp
